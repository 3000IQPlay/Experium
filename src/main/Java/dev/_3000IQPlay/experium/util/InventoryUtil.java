...
public class InventoryUtil
        ...
        switch (mode) {
            ...
            case SILENT: {
                if (!back && !switchedItem) {
                    ...
                    switchedItemSwitched[0] = false;
                    Experium.inventoryManager.recoverSilent(lastHotbarSlot);
                }
                switchedItemSwitched[1] = true;
                break;
            }
    ...
    public static int findBlockSlotInventory(Class<net.minecraft.block.BlockShulkerBox> clazz, boolean offHand, boolean withXCarry) {
