...
public class HoleFiller
    ...
    private void doHoleFill() {
        ...
        if (this.midSafeHoles.getValue().booleanValue()) {
            object = Experium.holeManager.getMidSafety();
            synchronized (object) {
                targets = new ArrayList<BlockPos>(Experium.holeManager.getMidSafety());
            }
        }
        object = Experium.holeManager.getHoles();
        synchronized (object) {
    ...
    private boolean check() {
        ...
        this.switchItem(true);
        if (!this.freecam.getValue().booleanValue() && Experium.moduleManager.isModuleEnabled(Freecam.class)) {
            return true;
        }
