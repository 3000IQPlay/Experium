...
public class Notifications
    ...
    public TextComponentString getNotifierOn(Module module) {
        if (ModuleTools.getInstance().isEnabled()) {
            switch (ModuleTools.getInstance().notifier.getValue()) {
				case EXPERIUM: {
                    TextComponentString text = new TextComponentString((Experium.commandManager.getClientMessage()) + " " + ChatFormatting.BOLD + module.getDisplayName() + ChatFormatting.RESET + ChatFormatting.GREEN + " enabled.");
                    return text;
                }
                case FUTURE: {
    ...
    public TextComponentString getNotifierOff(Module module) {
        if (ModuleTools.getInstance().isEnabled()) {
            switch (ModuleTools.getInstance().notifier.getValue()) {
				case EXPERIUM: {
                    TextComponentString text = new TextComponentString((Experium.commandManager.getClientMessage()) + " " + ChatFormatting.BOLD + module.getDisplayName() + ChatFormatting.RESET + ChatFormatting.RED + " disabled.");
                    return text;
                }
                case FUTURE: {
