...
public class Chams
    ...
    public Setting<Integer> hiddenRed = this.register(new Setting<Object>("Hidden Red", Integer.valueOf(135), Integer.valueOf(0), Integer.valueOf(255), v -> this.colored.getValue() != false && this.xqz.getValue() != false && this.rainbow.getValue() == false));
    ...
    public Setting<Integer> red = this.register(new Setting<Object>("Red", Integer.valueOf(135), Integer.valueOf(0), Integer.valueOf(255), v -> this.colored.getValue() != false && this.rainbow.getValue() == false));
    public Setting<Integer> green = this.register(new Setting<Object>("Green", Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(255), v -> this.colored.getValue() != false && this.rainbow.getValue() == false));
    public Setting<Integer> blue = this.register(new Setting<Object>("Blue", Integer.valueOf(255), Integer.valueOf(0), Integer.valueOf(255), v -> this.colored.getValue() != false && this.rainbow.getValue() == false));
