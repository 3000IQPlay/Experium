...
public class Surround
    ...
    public void onEnable() {
        ...
        switch (this.centerType.getValue()) {
            ...
            case Motion: {
                Experium.movementManager.setMotion(((double)this.startPos.getX() + 0.5 - Surround.mc.player.posX) / 2.0, Surround.mc.player.motionY, ((double)this.startPos.getZ() + 0.5 - Surround.mc.player.posZ) / 2.0);
            }
		}
        this.retries.clear();
