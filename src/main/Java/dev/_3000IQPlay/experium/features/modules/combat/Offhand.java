...
import dev._3000IQPlay.experium.mixin.mixins.accessors.IContainer;
import dev._3000IQPlay.experium.mixin.mixins.accessors.ISPacketSetSlot;
...
public class Offhand
    ...
    private boolean noNearbyPlayers() {
        return this.mode == Mode.CRYSTALS && Offhand.mc.world.playerEntities.stream().noneMatch(e -> e != Offhand.mc.player && !Experium.friendManager.isFriend(e) && Offhand.mc.player.getDistance(e) <= this.cTargetDistance.getValue().floatValue());
    }
