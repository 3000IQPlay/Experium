...
public class LongJump
    ...
    public LongJump() {
        super("LongJump", "Sends you flying like a pro", Module.Category.MOVEMENT, true, false, false);
    }
    ...
    public void onDisable() {
        Experium.timerManager.setTimer(1.0f);
    }
        ...
        switch (this.mode.getValue()) {
            ...
            case DIRECT: {
                ...
                if (!LongJump.mc.player.collidedVertically) {
                    ...
                    Experium.timerManager.setTimer(0.85f);
