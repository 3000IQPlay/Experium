...
public class HoleESP
	...
	private final Setting<Integer> bBoxTopAlpha = this.register(new Setting<Object>("BedrockBoxTopAlpha", Integer.valueOf(50), Integer.valueOf(0), Integer.valueOf(255), v -> this.renderBedrockHoles.getValue()));
	private final Setting<Integer> bBoxBottomAlpha = this.register(new Setting<Object>("BedrockBoxBottomAlpha", Integer.valueOf(50), Integer.valueOf(0), Integer.valueOf(255), v -> this.renderBedrockHoles.getValue()));
	private final Setting<Integer> oBoxTopAlpha = this.register(new Setting<Object>("ObsidianBoxTopAlpha", Integer.valueOf(50), Integer.valueOf(0), Integer.valueOf(255), v -> this.renderObsidiankHoles.getValue()));
	private final Setting<Integer> oBoxBottomAlpha = this.register(new Setting<Object>("ObsidianBoxBottomAlpha", Integer.valueOf(50), Integer.valueOf(0), Integer.valueOf(255), v -> this.renderObsidiankHoles.getValue()));
