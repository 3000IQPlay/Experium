    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : Experium.moduleManager.getCategories()) {
                ...
                for (Module module : Experium.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = Experium.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = Experium.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
