...
public class Button
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if (ClickGui.getInstance().buttonTextCenter.getValue().booleanValue()) {
            Experium.textManager.drawStringWithShadow(this.getName(), (float)this.x + (float)(this.width / 2.0f) - (float)(this.renderer.getStringWidth(this.getName()) / 2.0f), (float)this.y - 2.0f - (float)ExperiumGui.getClickGui().getTextOffset(), this.getState() ? ColorUtil.toRGBA(ClickGui.getInstance().textEnableC.getValue().getRed(), ClickGui.getInstance().textEnableC.getValue().getGreen(), ClickGui.getInstance().textEnableC.getValue().getBlue(), ClickGui.getInstance().textEnableC.getValue().getAlpha()) : ColorUtil.toRGBA(ClickGui.getInstance().textDisabledC.getValue().getRed(), ClickGui.getInstance().textDisabledC.getValue().getGreen(), ClickGui.getInstance().textDisabledC.getValue().getBlue(), ClickGui.getInstance().textDisabledC.getValue().getAlpha()));
        } else {
