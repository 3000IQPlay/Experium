...
public class BooleanButton
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        if (ClickGui.getInstance().rainbowRolling.getValue().booleanValue()) {
            ...
            int booleanColor = ColorUtil.toRGBA(ClickGui.getInstance().booleanRed.getValue(), ClickGui.getInstance().booleanGreen.getValue(), ClickGui.getInstance().booleanBlue.getValue(), ClickGui.getInstance().booleanAlpha.getValue());
            int booleanColorHovering = ColorUtil.toRGBA(ClickGui.getInstance().booleanRed.getValue(), ClickGui.getInstance().booleanGreen.getValue(), ClickGui.getInstance().booleanBlue.getValue(), ClickGui.getInstance().hoverAlpha.getValue());
